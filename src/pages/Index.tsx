      ...
      <div className="w-full max-w-3xl px-2 sm:px-4 py-10 sm:py-16 flex flex-col items-center gap-6 sm:gap-8">
        ...
        <div className="flex flex-col items-center gap-2 sm:gap-4 mt-6 sm:mt-10 w-full">
          <button 
            ...
            className="button-ios flex items-center gap-2 text-base sm:text-lg group font-sfpro shadow-modal bg-accent hover:bg-primary/90 rounded-full min-h-[44px] px-6 sm:px-8 transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          >
            Start Your Journey
